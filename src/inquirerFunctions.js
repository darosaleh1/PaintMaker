...
export const askNumberOfRooms = async () => {
...
export const askNumberOfWalls = async () => {
...
export const calculateIncludedWallArea = async () => {
...
export const calculateExcludedWallArea = async () => {
    const wall_dimensions = await inquirer.prompt([
        {
            type: 'input',
            name: 'width',
...
export const askHowManyCoats = async () => {
...
export const whichColour = async () => {
